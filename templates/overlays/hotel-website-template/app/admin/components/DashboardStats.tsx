...
interface DashboardStatsProps {
  totalLeads: number;
  totalProjects: number; // Represents totalRoomTypes
  apartmentsCount: number; // Represents deluxeCount
  plotsCount: number; // Represents standardCount
}
